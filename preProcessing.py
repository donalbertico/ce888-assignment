...
print(dataS1)
s1_x.to_csv("data/adult.csv", index=False)
s1_y.to_csv("data/adult_target.csv", index=False)
...
s2_x.to_csv("data/ionosphere.csv",index=False)
s2_y.to_csv("data/ionosphere_target.csv",index=False)
...
s3_x.to_csv("data/art_char.csv",index=False)
s3_y.to_csv("data/art_char_target.csv",index=False)
print(s3_x)
print(s3_y)
